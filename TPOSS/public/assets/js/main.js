...
window.colors = {
    ...
    function(a, e, t) {
        ...
        if (g.on("click", (function(a) {
                ...
                t(this);
                t(this).parent(".nav-search").find(".search-input").addClass("open"), w.focus(), b.removeClass("show")
        ...
        w.on("keyup", (function(a) {
            if (t(this).closest(".search-list").addClass("show"), 38 !== a.keyCode && 40 !== a.keyCode && 13 !== a.keyCode) {
                ...
                var e = t(this).val().toLowerCase(),
                    n = !1;
                if (t(this).parent().hasClass("bookmark-input") && (n = !0), "" != e) {
