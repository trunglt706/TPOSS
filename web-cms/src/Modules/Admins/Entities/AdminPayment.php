...
class AdminPayment extends Model
{
    ...
    public static function get_status($id = '')
    {
        $list = [
            ...
            self::STATUS_FAILED => [__('result_status_2'), COLORS['warning'], 'lock-on'],
        ];
    ...
    {
        $list = [
            self::TYPE_THU => [__('payment_type_1'), COLORS['success'], 'arrow-up'],
            self::TYPE_CHI => [__('payment_type_2'), COLORS['danger'], 'arrow-down'],
        ];
        return ($id == '') ? $list : $list[$id];
    }
